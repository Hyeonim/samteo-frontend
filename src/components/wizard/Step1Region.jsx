...
const REGION_IMAGES = {
  서울: '/regions/mascot-seoul.png',
  서울특별시: '/regions/mascot-seoul.png',
  인천: '/regions/mascot-incheon.png',
  인천광역시: '/regions/mascot-incheon.png',
  대전: '/regions/mascot-daejeon.png',
  대전광역시: '/regions/mascot-daejeon.png',
  대구: '/regions/mascot-daegu.png',
  대구광역시: '/regions/mascot-daegu.png',
  광주: '/regions/mascot-gwangju.png',
  광주광역시: '/regions/mascot-gwangju.png',
  부산: '/regions/mascot-busan.png',
  부산광역시: '/regions/mascot-busan.png',
  울산: '/regions/mascot-ulsan.png',
  울산광역시: '/regions/mascot-ulsan.png',
  세종: '/regions/mascot-sejong.png',
  세종특별자치시: '/regions/mascot-sejong.png',
  경기: '/regions/mascot-gyeonggi.png',
  경기도: '/regions/mascot-gyeonggi.png',
  강원: '/regions/mascot-gangwon.png',
  강원도: '/regions/mascot-gangwon.png',
  강원특별자치도: '/regions/mascot-gangwon.png',
  충북: '/regions/mascot-chungbuk.png',
  충청북도: '/regions/mascot-chungbuk.png',
  충남: '/regions/mascot-chungnam.png',
  충청남도: '/regions/mascot-chungnam.png',
  경북: '/regions/mascot-gyeongbuk.png',
  경상북도: '/regions/mascot-gyeongbuk.png',
  경남: '/regions/mascot-gyeongnam.png',
  경상남도: '/regions/mascot-gyeongnam.png',
  전북: '/regions/mascot-jeonbuk.png',
  전라북도: '/regions/mascot-jeonbuk.png',
  전북특별자치도: '/regions/mascot-jeonbuk.png',
  전남: '/regions/mascot-jeonnam.png',
  전라남도: '/regions/mascot-jeonnam.png',
  제주: '/regions/mascot-jeju.png',
  제주도: '/regions/mascot-jeju.png',
  제주특별자치도: '/regions/mascot-jeju.png',
}
